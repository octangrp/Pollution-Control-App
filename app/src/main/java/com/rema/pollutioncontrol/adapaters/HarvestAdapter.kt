...
class HarvestAdapter(private val harvests: ArrayList<Harvest>, var context: Context) : androidx.recyclerview.widget.RecyclerView.Adapter<HarvestAdapter.ViewHolder>() {
