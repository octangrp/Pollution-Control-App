...
class HarvestActivity : AppCompatActivity() {
    ...
    fun setUpdateData() {
        var harvest = Harvest(R.string.potatoes, R.drawable.ic_harvest_potatoes, Weather(AirQualityIndex(30), 40.0, 20.0, 120.0, 2), getString(R.string.potato_description))
        ...
        harvest = Harvest(R.string.sweet_potatoes, R.drawable.ic_harvest_sweet_potatoes, Weather(AirQualityIndex(50), 30.0, 25.0, 130.0, 1), getString(R.string.sweet_potato_description))
        ...
        harvest = Harvest(R.string.bananas, R.drawable.ic_harvest_bananas, Weather(AirQualityIndex(50), 45.0, 19.0, 90.0, 1), getString(R.string.bananas_description))
        ...
        harvest = Harvest(R.string.beans, R.drawable.ic_harvest_beans, Weather(AirQualityIndex(50), 30.0, 23.0, 80.0, 1), getString(R.string.beans_description))
        harvest.locations.add(Location("Muhanga", "Eastern Province"))
        harvest.locations.add(Location("Ruhango", "Eastern Province"))
